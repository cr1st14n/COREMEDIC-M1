	...
	switch (tip) {
		case 1:
			...
			if (form.checkValidity()) {
				...
				$.post('/COREMEDIC-M1/RRHH/personal/revCiEmail', data)
					.done(function(data) {
						switch (data) {
							case 'ciYaExistente':
		...
		case 2:
			...
			if (form2.checkValidity()) {
				...
				$.post('/COREMEDIC-M1/RRHH/personal/createUser', data)
					.done(function(rest) {
						if (rest == 'succes') {
...
function listTodosEmp() {
	$.get('/COREMEDIC-M1/RRHH/personal/showEmpTodos')
		.done(function(data) {
			var html = data
				.map(function(elem) {
					return `<tr>
...
function showDatosEmp(id) {
	$.get('/COREMEDIC-M1/RRHH/personal/showDatosEmp/' + id + '')
		.done(function(elem) {
			console.log(elem);
			console.log(elem[0]);
			console.log(elem[1]);
			...
			var html2 = `
                ...
                Area Designada: <strong>${elem[1].uc_area} </strong><br>
                Cargo: <strong>${elem[1].uc_cargoDesignado} </strong><br>
				Tipo de Contrato: <strong>${elem[1].uc_tipoContrato}</strong><br><hr>
                Modulo de sistema designado : <strong>${elem[0].usu_area}</strong><br>
...
function showEditDat1User(id) {
	data = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/editDatos1Emp/', data, function(data) {
		console.log(data);
...
function updateUser() {
	...
	if (cons != null) {
		...
		$.post("/COREMEDIC-M1/RRHH/personal/updateDatos1Emp", datos,
			function (data) {
				console.log(data);
			 if (data==1) {
		...
		/* $.post('/COREMEDIC-M1/RRHH/personal/updateDatos1Emp', dato, function(data) {
			console.log(data);
			switch (data) {
				case 'success':
					document.getElementById('btn-editDatuser-close').click();
...
function showEditDat2User(id) {
	...
	var data = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/editDatos2Emp', data, function(data) {
		console.log(data);
...
function updateUser2() {
	...
	if (id > 0 && id1 > 0 && id2 > 0) {
		...
		$.post("/COREMEDIC-M1/RRHH/personal/updateDatos2Emp", data,
			function (data) {
				if (data=='success') {
...
function showUserVacaciones(id) {
	...
	$('#usuVacacId').val(id);
	var data = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/vacacion/index', data, function(data) {
...
function listFaltas() {
  ...
  <th>*</th>
	...
	$.get('/COREMEDIC-M1/RRHH/personal/faltas/list', data, function(data, textStatus, jqXHR) {
		var html = data
			.map(function(e) {
				return `<tr>
       <td>${e.uf_codDoc}</td>
...
function listPermisos() {
  ...
  <th>*</th>
	...
	document.getElementById('head-listFaltasPermisos').innerHTML = headhtml;
	var data = { userId: $('#codUsu1').val() };
	$.get('/COREMEDIC-M1/RRHH/personal/permiso/show', data, function(data, textStatus, jqXHR) {
		var html = data
			.map(function(e) {
				return `<tr>
...
function listCambioTurno() {
  ...
  <th>*</th>
	...
	$.get('/COREMEDIC-M1/RRHH/personal/cambioTurno/list', dat, function(data) {
		var html = data
			.map(function(e) {
				return `<tr>
        <td>${e.uct_codDoc}</td>
...
function permisoCreate() {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/permiso/create', data, function(data, textStatus, jqXHR) {
		if (data == 'success') {
...
function ShowModalEditPermiso(idPermiso) {
	...
	$.get('/COREMEDIC-M1/RRHH/personal/permiso/edit', data, function(data, textStatus, jqXHR) {
...
function permisoUpdate(param) {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/permiso/update', data, function(dat, textStatus, jqXHR) {
		listPermisos();
...
function permisoDestroy(id) {
	var data = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/permiso/destroy', data, function(data, textStatus, jqXHR) {
		if (data == 'success') {
...
function createFalta() {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/faltas/create', data, function(data, textStatus, jqXHR) {
		console.log(data);
		if (data == 'success') {
...
function ShowModalEditFalta(idFalta) {
	var data = { id: idFalta };
	$.get('/COREMEDIC-M1/RRHH/personal/faltas/edit', data, function(data, textStatus, jqXHR) {
		console.log(data);
...
function updateFalta() {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/faltas/update', data, function(data, textStatus, jqXHR) {
		if (data == 'success') {
...
function deleteFalta(id) {
	...
	if (r == true) {
		console.log(data);
		$.post('/COREMEDIC-M1/RRHH/personal/faltas/delete', data, function(data, textStatus, jqXHR) {
			if (data == 'success') {
...
function CamTurnCreate() {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/cambioTurno/create', data, function(data, textStatus, jqXHR) {
		console.log(data);
		if (data == 'success') {
			listCambioTurno();
...
function showModalCambioturno(id) {
	var dat = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/cambioTurno/edit', dat, function(data, textStatus, jqXHR) {
...
function updateCambTurno(param) {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/cambioTurno/update', data, function(data, textStatus, jqXHR) {
		if (data) {
			notif('1', 'Actualizado');
			listCambioTurno();
...
function deleteCambTurn(id) {
	...
	if (r == true) {
		...
		$.post('/COREMEDIC-M1/RRHH/personal/cambioTurno/delete', data, function(data, textStatus, jqXHR) {
			if (data == 'success') {
...
function deleteUser(id) {
	var data = { id: id };
	$.get('/COREMEDIC-M1/RRHH/personal/datos1User', data, function(data) {
		$('#message-delete').text(
...
function DestroyUser(id) {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/destroy', data, function(data) {
		if (data == 'success') {
			listTodosEmp();
			notif('1', 'Registro Eliminado');
...
$.get("/COREMEDIC-M1/RRHH/personal/vacacion/showDayV", data,
...
function vacacionCreate(param) {
	...
	if (moment(date1, 'YYYY-MM-DD').format('YYYY-MM-DD') <= moment(date2, 'YYYY-MM-DD').format('YYYY-MM-DD')) {
		...
		$.post('/COREMEDIC-M1/RRHH/personal/vacacion/create', data, function(data) {
			if ((data = 'success')) {
...
function listVacacUser(id) {
	...
	$.get('/COREMEDIC-M1/RRHH/personal/vacacion/list1', data, function(data) {
    console.log(data);
    var html = data
			.map(function(e) {
				return `
...
var data={id:id};
$.get("/COREMEDIC-M1/RRHH/personal/vacacion/edit", data,
  function (data) {
...
console.log(data);
$.post("/COREMEDIC-M1/RRHH/personal/vacacion/update", data,
  data => {
    console.log(data);
   if (data=='1') {
     notif('1','Registro actualizado');
...
function DestroyVacacion(id) {
	...
	$.post('/COREMEDIC-M1/RRHH/personal/vacacion/destroy', data, function(e) {
		if (e == 'success') {
...
$('#btn-print_datosPersonal1').click(function (e) { 
	e.preventDefault();
	var html=`<embed src="http://localhost/COREMEDIC-M1/print.pdf" width="1000" height="800" frameborder="0" allowfullscreen>`;
	$('#md-pagImprecion').html(html);
	$('#md-pagImprecion').modal('show');
});

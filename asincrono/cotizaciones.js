            ...
            e.usu_appaterno
                    ...
                    <td>
                        <span class="tooltip-area">
                            ...
                            <button onClick="imprimirCotizacion(${
                              e.id
                            })"  class="btn btn-default btn-sm" title="Imprimir" data-original-title="Edit"><i class="fa fa-print"></i></button>
...
$("#NOMBRESpaciente_preCot").keyup(function (e) {
  ...
  if (nombres == "") {
    ...
    $.get("/COREMEDIC-M1/api/buscarPacienteNombre/" + nombres + "", function (
      paciente
    ) {
      listPacientes(paciente);
      /*$('#resulBusqPacientes').html("");

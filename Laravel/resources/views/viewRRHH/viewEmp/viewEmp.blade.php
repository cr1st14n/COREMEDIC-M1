    ...
    <div class="modal-body">
        <div class="row">
            <form class="form-horizontal" data-collabel="6" data-alignlabel="right" id="formulario2">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <h5 align="center"><span>Detalle de acceso al sistema WEB </span></h5><br>
...
<div id="md-stack1" class="modal fade md-stickTop" tabindex="-1" data-width="800">
    ...
    <div class="modal-body">
        ...
        <div class="footer-modal">
            <button class="btn btn-theme-inverse" id="btn-print_datosPersonal1"><i class="fa fa-print"></i> Imprimir datos de personal actualizado</button>
        </div>
    </div>
</div>

<div id="md-pagImprecion" class="modal fade md-sickTop" tabindex="-1" data-width="900" data-he>
    
    <embed src="http://www.f2i2.net/web/publicaciones/libro_seguridad_industrial/lsi.pdf" width="1000" height="800" frameborder="0" allowfullscreen>
</div>

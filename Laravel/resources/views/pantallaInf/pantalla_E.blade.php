...
<body>
    <video autoplay muted loop id="myVideo">
        <source src="{{ asset('plantillaPantalla\videoPantalla\videoNavidad.mp4') }}" type="video/mp4">
    ...
    <div class="row">
        <button class="btn btn-block">hola mundo</button>
        <div class="col-lg-11" align="center" id="bluuu">
            <h1 style="color: white;"> <strong> CENTRO DE SALUD JESUS OBRERO - HORARIOS DE ATENCIÓN</strong></h1>

        </div>
        <div class="col-lg-1">
            <img class="logo1" id="open-button" src="{{ asset('plantillaPantalla/images/logo_csjo.jpg') }}" alt="">
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="table-users">
                ...
                <table cellspacing="0">
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/galves.png') }}" alt="" /></td>
                        <td>Dra. Galvez</td>
                    ...
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/gutierrez.png') }}" alt="" /></td>
                        <td>Dra. Gutierrez</td>
        ...
        <div class="col-lg-4">
            <div class="table-users">
                ...
                <table cellspacing="0">
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/huallani.png') }}" alt="" /></td>
                        <td>Dr. Huallani</td>
            ...
            <div class="table-users">
                ...
                <table cellspacing="0">
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/florez.png') }}" alt="" /></td>
                        <td>Dr. Flores</td>
                        <td>Martes, Jueves </td>
            ...
            <div class="table-users">
                ...
                <table cellspacing="0">
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/IrmaRojas.png') }}" alt="" /></td>
        ...
        <div class="col-lg-4">
            ...
            <div class="table-users">
                ...
                <table cellspacing="0">
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/lazo.png') }}" alt="" /></td>
                        <td>Dr. Lazo</td>
                        <td>Lunes a Viernes </td>
                        <td>Hrs 9:30</td>
                    </tr>
                    <tr>
                        <td><img src="{{ asset('plantillaPantalla/images/santander.png') }}" alt="" /></td>
                        <td>Dr. Santander</td>
    ...
    <section id="modal-1" class="modal-container">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <!-- <embed src="http://localhost/COREMEDIC-M1/plantillaPantalla\videoPantalla\videoFarmacia.mp4" type="video/mp4" height="300" > -->
                <iframe src="http://localhost/COREMEDIC-M1/plantillaPantalla\videoPantalla\videoFarmacia.mp4" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                <table>
                    <thead>
                        <tr>
                            <th>asdf</th>
    ...
    <script>
        ...
        var openButton = document.querySelector("#bluuu");

        openButton.addEventListener("click", function() {
            modal.open();
        });
        // setTimeout(() => {
        //     document.getElementById('bluuu').click();
        // }, 3000);
        console.clear();
